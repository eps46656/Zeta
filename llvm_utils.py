...
class LLVMCompiler:
    def __init__(self, config: LLVMCompilerConfig):
        ...
        self.compile_executable = {
            utils.Language.C: "clang",
            utils.Language.CPP: "clang",
        }
    ...
    def compile_to_obj(
        ...
        self.run_command_(
            self.compile_executable[lang.base],
            "--compile",
            "-o", dst,
            *self.compile_args[lang.base],
            "-x", get_clang_lang(lang),
    ...
    def asm_to_obj(self, dst: utils.PathLike, src: utils.PathLike) -> None:
        dst = utils.to_pathlib_path(dst)
        src = utils.to_pathlib_path(src)
    ...
    def ll_to_asm(self, dst: utils.PathLike, src: utils.PathLike) -> None:
        dst = utils.to_pathlib_path(dst)
        src = utils.to_pathlib_path(src)
    ...
    def ll_to_obj(self, dst: utils.PathLike, src: utils.PathLike) -> None:
        dst = utils.to_pathlib_path(dst)
        src = utils.to_pathlib_path(src)
