...
constexpr unsigned long long hash::BasicHasher<pair::Pair<First, Second>>::Hash(
...
constexpr auto comparison::BasicComparator<pair::Pair<AFirst, ASecond>,
                                           pair::Pair<BFirst, BSecond>>::
    Compare(comparison::Tag, OpTag op, pair::Pair<AFirst, ASecond> const& a,
