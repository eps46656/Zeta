...
hash::HasherTraits<hash::BasicHasher<pair::Pair<First, Second>>>::Hash(
...
constexpr auto comparison::ComparatorTraits<comparison::BasicComparator<
    ...
    Compare(comparison::BasicComparator<pair::Pair<AFirst, ASecond>,
                                        pair::Pair<BFirst, BSecond>>,
            OpType op, pair::Pair<AFirst, ASecond> const& a,
