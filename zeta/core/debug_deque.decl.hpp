...
struct DebugDeque;
struct DebugDeque_Cursor;

// -----------------------------------------------------------------------------

struct DebugDeque : public seq_cntr::SeqCntr {
    ...
    void Write(void const* pos_cursor, size_t cnt, const Writer& writer,
               void* dst_cursor);

    template <typename ReaderWriter>
    void ReadWrite(void const* pos_cursor, size_t cnt,
    ...
    void Assign(size_t dst_beg, DebugDeque* src_ca, size_t src_beg, size_t cnt);
    ...
    void ReadWriteTemp_(void const* pos_cursor, size_t cnt,
                        const ReaderWriter& reader_writer, void* dst_cursor);
};
